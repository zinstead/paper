...
import { Sequence } from "@/components/molstar/mol-plugin-ui/sequence/sequence";
import {
  Structure,
  StructureElement,
      ...
      return (
        <div className="msp-sequence">
          <div className="msp-sequence-select">
            ...
            <div className="msp-sequence-header">Sequence</div>
    ...
    return (
      <div className="msp-sequence">
        {/* <div className="msp-sequence-select">
          ...
          <PureSelectControl
            title={`[Mode]`}
            param={this.state.sequenceViewModeParam}
            name="mode"
            value={values.mode}
            onChange={this.setParamProps}
          />
